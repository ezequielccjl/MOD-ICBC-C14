...
public class GetNewClientContentBLR {
	...
	@When("llamamos al metodo getFaqContent con {string} {string} {string} {string} {string}")
	public void llamamosAlMetodoGetFaqContentCon(String transactionId, String channel, String userId, String password, String resultCode) {
