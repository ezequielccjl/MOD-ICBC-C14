...
@CucumberOptions()
public class PaymentAvailableMBR {

	private static Response response;
	private static String hzSessionId;
	
	@Given("nos logueamos con los datos {string} {string} {string}")
	public void nosLogueamosConLosDatos(String user, String pass, String deviceId) {
	...
	@When("llamo al metodo paymentAvailableMBR con {string}")
	public void llamoAlMetodoPaymentAvailableMBRCon(String transactionId) {
...
//					body(matchesJsonSchemaInClasspath("schemas/schemaListProducts.json")).
	...
	public void validamosQueElCodigoDeRespuestaSeaCorrecto() {
