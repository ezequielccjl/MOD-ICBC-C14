...
public class GetFaqContentBLR {
	...
	@When("llamo al metodo getFaqContent con {string} {string} {string}")
	public void llamoAlMetodoGetFaqContentCon(String channel, String transactionId, String resultCode) {
