...
@CucumberOptions()
public class GetSegCanalesContentMBR {

	private static Response response;
	private static String hzSessionId;
	
	@Given("ejecutamos el login con {string} {string} {string}")
	public void ejecutamosElLoginCon(String user, String pass, String deviceId) {
	...
	@When("llamo al metodo getSegCanalesContentMBR con {string} {string}")
	public void llamoAlMetodoGetSegCanalesContentMBRCon(String channel, String transactionId) {
...
//					body(matchesJsonSchemaInClasspath("schemas/schemaListProducts.json")).
	...
	public void validamosElCodigoDeLaRespuesta() {
