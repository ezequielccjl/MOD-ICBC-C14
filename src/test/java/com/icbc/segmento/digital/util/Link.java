...
public class Link {
    ...
    public static final String LISTTWELVESTATEMENTBLR = "https://blr-card-3-0-dev.apps.ocp4-tst.intranet.local/card/3.0/list-twelve-statement";
    public static final String LISTTWELVESTATEMENTMBR = "https://mbr-channel-card-2-0-dev.apps.ocp4-tst.intranet.local/channel-card/2.0/list-twelve-statement";
    ...
    public static final String GENERATESECONDFACTORBLR = "https://blr-client-1-0-dev.apps.ocp4-tst.intranet.local/client/1.0/generate-second-factor";
