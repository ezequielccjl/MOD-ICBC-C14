Feature: Servicio - MBR channel-transfer-account destination-info
  ...
  Scenario Outline: Llamada al metodo POST destinationInfoMBR
    ...
    When Realiza la consulta con "<transactionId>" "<destinationAliasCbuCvu>"
    Then Se verifica el codigo de respuesta

    Examples: 
      | user     | pass     | deviceId|transactionId                       | destinationAliasCbuCvu  |
      | corona01 | Prueba01 |         |ad4ca27c-a637-4207-8b32-69ee962fc287|1430001713000000360014	 |
