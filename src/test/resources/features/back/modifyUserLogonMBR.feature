...
Feature: Servicio - llamada al metodo POST modifyUserLogonMBR
  ...
  Scenario Outline: llamada al metodo POST modifyUserLogonMBR
    ...
    When llamo al metodo modifyUserLogonMBR con "<channel>" "<transactionId>" "<klogonUserId>" "<klogonType>" "<klogonNum>" "<klogonPass>" "<kgender>" "<resultCode>"
    ...
    Examples: 
      ...
      |F27308585|prueba01|					| mbr			|9f73364f-28e4-4729-84b8-47363713a7c4 | m20444413		 | 04 				| 20444413  | 				   | M			 | ERROR			|